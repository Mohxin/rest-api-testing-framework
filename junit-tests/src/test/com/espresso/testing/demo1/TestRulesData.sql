...
INSERT INTO purchaseorder (order_number, amount_total, paid, notes, customer_name, salesrep_id, item_count) VALUES (1, 35, 0, 'This is a small order', 'Alpha and Sons',1,2);
INSERT INTO purchaseorder (order_number, amount_total, paid, notes, customer_name, salesrep_id, item_count) VALUES (2, 675, 1, '', 'Bravo Hardware',2,2);
INSERT INTO purchaseorder (order_number, amount_total, paid, notes, customer_name, salesrep_id, item_count) VALUES (3, 60, 0, 'Please rush this order', 'Bravo Hardware',1,2);
INSERT INTO purchaseorder (order_number, amount_total, paid, notes, customer_name, salesrep_id, item_count) VALUES (4, 85, 0, 'Deliver by overnight with signature required', 'Charlie''s Construction',2,2);
INSERT INTO purchaseorder (order_number, amount_total, paid, notes, customer_name, salesrep_id, item_count) VALUES (5, 135, 0, '', 'Charlie''s Construction',1,2);
INSERT INTO purchaseorder (order_number, amount_total, paid, notes, customer_name, salesrep_id, item_count) VALUES (6, 50, 0, 'Pack with care - fragile merchandise', 'Alpha and Sons',2,2);
